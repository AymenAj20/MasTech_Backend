...
router.get('/generate-rapport',setRole('chefProjet'),verifyToken,rapportController.generateRapport) // Genere et retourne un rapport
...
router.put('/:id',uploadOptions.single('image'),chefProjetController.updateChefProjet) // Modifier un ChefProjet 
